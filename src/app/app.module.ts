...
import { IgxAvatarModule, IgxGridModule, IgxSimpleComboModule, IgxSelectModule, IgxComboModule, IgxInputGroupModule, IgxCardModule, IgxButtonModule, IgxRippleModule } from '@infragistics/igniteui-angular';
